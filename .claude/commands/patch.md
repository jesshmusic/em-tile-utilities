---
description: Increment patch version, run tests/linting, commit, push, and create PR
---

Follow this workflow to create a release:

1. **Increment Patch Version**:
   - Run `npm run release:patch` to bump the version and generate changelog
...
3. **Commit Changes**:
   - Add all changed files: `git add package.json module.json CHANGELOG.md build-info.json src/ dist/`
